...
<body class="index h-screen flex items-center justify-center  ">
    ...
    <div class="flex h-4/5 w-5/6 overflow-hidden justify-center sm:content-center bg-gray-200 shadow-xl  rounded-xl z-20  ">
        ...
        <div class="flex flex-col items-center p-5  w-full overflow-hidden sx:max-w-ssx sm:border border-gray-BD bg-gray-200 rounded-3xl text-gray-33  ">
            ...
            <div class="my-8">
                <h3 class="font-semibold text-lg text-center" > Iniciar Sesión </h3>
                <h3 class="font-semibold text-sm text-center" > Bienvenido a Auto Import </h3>
            </div>
            ...
            <form action="./php/login.php" method="post" class=" w-full flex flex-col px-5 gap-4 relative text-gray-500">
                ...
                if (isset($_SESSION['error_message'])) {
                    echo '<p style="margin-left: -1rem" id="msj" class="text-red-500 w-full text-center absolute transform duration-500 ease-in-out mb-12 bottom-8" >' . $_SESSION['error_message'] . '</p>';
                ...
                <button class="w-1/2 py-3 mt-2 self-center bg-orange-600 rounded-lg text-sm leading-normal font-semibold text-white" type="submit">Inicia sesión</button>
            </form>

            <!-- Sección de inicio de sesión con redes sociales -->
            <div class="mt-8 flex flex-col gap-6 items-center text-sm text-gray-500">
            
                <p class=" w-fit text-[17px] text-gray-33">¿No tienes una cuenta? <a href="./pages/register.php" class="text-orange-600">Regístrate</a></p>
            </div>
