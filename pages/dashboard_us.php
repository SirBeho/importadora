...
<main class="h-full min-h-full w-full flex flex-col bg-gray-200 dark:bg-gray-800 dark:text-white ">
    ...
    <div class="w-full  p-3   ">
        <div class="flex w-full gap-2  ">
            <form id="cuadro" action="../php/buscar.php" method="post" class="rounded-lg shadow-sm bg-white w-3/5  flex flex-col">
                <span class="block text-3xl font-bold m-4  border-b-2 border-orange-300 relative ">!<span
            ...
            <div id="cuadro" action="../php/buscar.php" method="post" class=" flex flex-col rounded-lg shadow-sm w-2/5 bg-white ">
                <span class="block text-3xl font-bold m-4  border-b-2 border-orange-300 relative ">!Ofertas Para Ti!
                </span>
            </div>
        </div>
